                        ...
                        break
                         case 'coal':
                            if (global.db.data.users[m.sender].money >= bcoal * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Kuali dengan harga ${bcoal * count} money`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} Kuali dengan harga ${bcoal * count} money`.trim(), m)
