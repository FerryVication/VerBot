        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.email)) user.email = ''
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Oopss.... Limit Kamu Habis Nih🙃 Silahkan Ketik .infolimit`, m)
                        continue // Limit habis
                    }
                    if (plugin.level > _user.level) {
                        this.reply(m.chat, `diperlukan level ${plugin.level} untuk menggunakan perintah ini. Level kamu ${_user.level} Teruslah berinteraksi dengan bot agar kamu naik level!`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: '🙃Fitur Ini Hanya Bisa Digunakan Oleh Pengguna Premium, Silahkan Upgrade ke Premium Dengan Cara Ketik .buyprem',
        group: 'Perintah ini hanya dapat digunakan di grup!',
        private: 'Perintah ini hanya dapat digunakan di Chat Pribadi!',
        admin: 'Perintah ini hanya untuk *Admin* grup!',
        botAdmin: 'Jadikan bot sebagai *Admin* untuk menggunakan perintah ini!',
        unreg: '🕊️ *Terima Kasih Telah Menghubungi VerBotX* 🕊️\n🍁 *Namun Untuk Bisa Menggunakan Fitur VerBotX Kamu Harus Mendaftar Terlebih Dahulu Menggunakan Alamat Email Kamu Dengan Cara Mengetik* :\n\n *#reg email|nama|umur* \n\n\n *Contoh* : #reg verbot@gmail.com|Feri|18\n\n *Note* :\n _Sangat Diwajibkan Untuk Menggunakan Alamat Email Yang Masih Aktif Karena Untuk Menerima Kode OTP ⚡',
